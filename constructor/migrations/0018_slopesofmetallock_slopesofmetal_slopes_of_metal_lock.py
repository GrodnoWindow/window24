...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('constructor', '0017_alter_casingnipelprice_options'),
    ]

    operations = [
        migrations.CreateModel(
            name='SlopesOfMetalLock',
            fields=[
        ...
        migrations.AddField(
            ...
            name='slopes_of_metal_lock',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='constructor.slopesofmetallock', verbose_name='замок'),
        ),
    ]

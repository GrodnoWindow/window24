...
urlpatterns = [
    ...
    path('calculation/additional-profile/', CalculationAdditionalProfileAPIView.as_view()),
    path('calculation/connection-profile/', CalculationConnectionProfileAPIView.as_view()),
    path('calculation/other-complectation-profile/', CalculationOtherComplectationProfileAPIView.as_view()),
